...
const Contact = () => {
  return (
    <div id='contact' className='max-w-[1140px] m-auto w-full p-4 py-16'>
      ...
      <p className='text-center text-gray py-2'>We're standing by!</p>
      <div className='grid md:grid-cols-2'>
        <img className='w-full md:h-full object-cover p-2 max-h-[500px] h-[200px]' src="./images/contact.jpg" alt="/" />
        <form>
